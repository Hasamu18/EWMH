...
const PdfViewer = () => {
  ...
  const evidenceUrl = `https://firebasestorage.googleapis.com/v0/b/sep490-8888.appspot.com/o/RequestDetails%2FRQPOST_${idWithoutPrefix}?alt=media`;
  ...
  useEffect(() => {
    navigation.setOptions({
      headerTitle: "Nghiệm thu và bằng chứng sửa chữa",
