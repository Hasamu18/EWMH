...
public partial class Sep490Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Accounts__349DA5A6E439BC94");

            entity.HasIndex(e => e.PhoneNumber, "UQ__Accounts__85FB4E382A2E194E").IsUnique();
        ...
        {
            entity.HasKey(e => e.AreaId).HasName("PK__Apartmen__70B8204890DC8A62");

            entity.HasIndex(e => e.Name, "UQ__Apartmen__737584F6954914F5").IsUnique();
        ...
        {
            entity.HasKey(e => e.ContractId).HasName("PK__Contract__C90D346913B65585");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64D8AB73B17A");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDD6B1DBB8A1");
        ...
        {
            entity.HasKey(e => e.LeaderId).HasName("PK__Leaders__FCCA6516CF65B962");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ProductId }).HasName("PK__OrderDet__08D097A3F3D124AE");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BCF8D5366C6");
        ...
        {
            entity.HasKey(e => e.PriceRequestId).HasName("PK__PriceReq__082B9AAAB17B2034");
        ...
        {
            entity.HasKey(e => e.ProductPriceId).HasName("PK__ProductP__92B9436F2C4D7521");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CDC3631C8F");
        ...
        {
            entity.HasKey(e => e.RefreshTokenId).HasName("PK__RefreshT__F5845E391EDAA939");
        ...
        {
            entity.HasKey(e => e.RequestDetailId).HasName("PK__RequestD__DC528B90CAB93B52");
        ...
        {
            entity.HasKey(e => new { e.RequestId, e.WorkerId }).HasName("PK__RequestW__43DF99F85F43637C");
        ...
        {
            entity.HasKey(e => e.RequestId).HasName("PK__Requests__33A8517AE4E233DD");
        ...
        {
            entity.HasKey(e => new { e.RoomId, e.AreaId }).HasName("PK__Rooms__A58DBB3D284DFA8D");
        ...
        {
            entity.HasKey(e => e.ServicePackagePriceId).HasName("PK__ServiceP__290654CC731E6E1D");
        ...
        {
            entity.HasKey(e => e.ServicePackageId).HasName("PK__ServiceP__0747A82FBA09203B");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A6B3AB09400");
        ...
        {
            entity.HasKey(e => e.WorkerId).HasName("PK__Workers__077C88261E1270FB");
